...
При введении текста в аннотацию она автоматически увеличивается, но также можно вручную изменить ее размер, потянув за правый нижний угол (не в Firefox, там опять же была проблема). Нажатием клавиши escape снимается фокус с аннотации. Если с пустой аннотации снять фокус, она удаляется.
...
Еще было непросто в коде различить перемещение аннотации от изменения ее размера через перемещение ее правого нижнего уголка. Хотелось использовать нативный способ изменения размера. Я думаю, по-хорошему лучше создать кастомный элемент-уголок + кастомную логику ресайза. Это более гибко и надежно.
